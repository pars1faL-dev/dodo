        ...
        <div class="row">   <!-- header -->
            ...
            <div class="bsk-box bg-white border rounded col-3 pt-3"> <!-- Корзина -->
            	<?php 
            		...
            		$query = mysqli_query($con, "SELECT * FROM trash");
                ...
                <div class="row">
                    ...
                    <div class="col-2 mt-2"> 
                    	<form>
                    		...
                    		<input style="display: none" class="form-control" type="text" name="img" value="<?php echo $stroka["img"] ?>">
                    		<input style="display: none" class="form-control" type="text" name="price" value="<?php echo $stroka["price"] ?>">
